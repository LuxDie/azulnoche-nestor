...
public class HistoriaLogica {
    ...
    private void cargarMensjesObjetos_Bosque() {
        ...
        this.narracion.agregarMensaje("bosque5", "Llegas a la cabaña. Las ventanas estan tapiadas. Intetas abrirlas pero es imposible hacerlo solo con las manos."/*+" La puerta esta cerrada y asegurada con un gran candado de clave numerica. Hacen falta cuatro numeros para poder abrirlo."*/, "bosque4");
